...
public class Appli2 extends JPanel{
    ...
    public int avan  = 0 ;
    public int ori = 0 ;
    public String personnage = "VEGETA" ;
    public String personnage2 = "BROLY";
	...
	if(stage == 1 ){
	    ...
	    }else if(personnage.equals("VEGETA")){
		
		
		if(orientation == 0){
		    ImageIcon aaa = new ImageIcon("vegeta/vegeta.png");
		    Image q= aaa.getImage();   
		    g.drawImage(q,x,y,70,80,this);
		...
		if(orientation== 1){
		    ImageIcon aaa = new ImageIcon("vegeta/vegetajump.png");
		    Image q= aaa.getImage();   
		...
		if(orientation == 2){
		    switch(avance){
		    case 0 : 	ImageIcon z = new ImageIcon("vegeta/vegetak.png");
			Image qq  = z.getImage();   
				
			g.drawImage(qq,x,y,70,80,this);
			break ;
		    case 1: 	ImageIcon a1 = new ImageIcon("vegeta/vegetak2.png");
			Image qqq = a1.getImage();   
			...
			ImageIcon a2 ;
			if(Math.random()<0.5)
			    a2 = new ImageIcon("vegeta/poing.png");
			else
			    a2 = new ImageIcon("vegeta/punch.png");
			Image q2= a2.getImage();   
			...
			ImageIcon a3 ;
			if(Math.random()>0.5)	
			    a3 = new ImageIcon("vegeta/poing2.png");
			else
			    a3 = new ImageIcon("vegeta/punch2.png");
			Image q3= a3.getImage();   
		    ...
		    case 4: 	ImageIcon a4 = new ImageIcon("vegeta/punch.png");
			Image q5= a4.getImage();   
		    ...
		    case 5 :
			ImageIcon r2 = new ImageIcon("vegeta/poing.png");
			Image qr2= r2.getImage();   

			g.drawImage(qr2,x,y,70,90,this);
			break ;
		    case 6 :
			ImageIcon r = new ImageIcon("vegeta/poing2");
			Image qr= r.getImage();   
		...
		if(orientation == 3){
		    switch(avance){
		    case 0 : ImageIcon a4 = new ImageIcon("vegeta/vegetare.png");
			Image q5= a4.getImage();   

			g.drawImage(q5,x,y,70,80,this);
			break ;
		    case 1 :ImageIcon a2 = new ImageIcon("vegeta/sayen.png");
			Image q2= a2.getImage();   
		...
		if(orientation== 5){
		    ImageIcon aaa = new ImageIcon("vegeta/vegetakneel.png");
		    Image q= aaa.getImage();   
				
		    g.drawImage(q,x,y,60,70,this);
